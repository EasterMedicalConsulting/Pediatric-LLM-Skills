...
2. Copy the **entire prompt block** (clearly marked in each file).
...
- **Save your prompt.** If you build a dot phrase or letter you like, save the inputs as a personal template so next time is even faster.
